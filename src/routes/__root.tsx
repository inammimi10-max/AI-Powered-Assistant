...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Automate emails, meeting summaries, task plans, research, and chat with a single AI-powered workplace assistant." },
      { property: "og:title", content: "Nexus AI — Workplace Productivity Assistant" },
      { property: "og:description", content: "Automate emails, meeting summaries, task plans, research, and chat with a single AI-powered workplace assistant." },
